...
let nombreUsuario = "Anderson Tobòn";
...
function extraerDinero() {
  ...
  if(dineroAExtraer % 100 !==0 ){
    alert("OJO!! solo ingresar cantidades de 100");
...
//isNaN me indica que si al ingresar cualquier caracter diferente a letra me retorna false
  if(isNaN(nuevoLimite)==true){   
    alert("OJO, POR FAVOR INGRESAR SOLO NÙMEROS");
  }else{
    limiteExtraccion = nuevoLimite;
    actualizarLimiteEnPantalla();
    alert("Pum pum!! Se ha actualizado tu límite de extracción, nuevo valor " +limiteExtraccion);
  }


}

//Evento para hace cierre de sesion.
